...
class ServerApiTests(unittest.TestCase):
    ...
    def test_status_and_diagnostics_do_not_expose_token(self) -> None:
        ...
        self.assertEqual(
            status["repo_versions"]["stable"],
            server.STABLE_REPO_VERSION if server.STABLE_REPO_VERSION else "n/a",
        )
        self.assertEqual(
            status["repo_versions"]["rc"],
            server.RC_REPO_VERSION if server.RC_REPO_VERSION else "n/a",
        )
        self.assertEqual(
            status["repo_versions"]["dev"],
            server.DEV_REPO_VERSION if server.DEV_REPO_VERSION else server.APP_VERSION,
        )
